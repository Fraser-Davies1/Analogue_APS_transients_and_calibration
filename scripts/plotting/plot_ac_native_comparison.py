...
def plot_ac_native_comparison():
    print("--- Generating Native AC Coupled Grounding Comparison ---")
    ...
    data_g_path = os.path.join(data_dir, "grounded_ac_native.npz")
    data_u_path = os.path.join(data_dir, "ungrounded_ac_native.npz")
    ...
    plt.title("Analogue APS Native AC-Coupled Noise PSD Comparison\nFaraday Cage Verification (Hardware AC Filter)")
    ...
    save_path = os.path.join(plot_dir, "noise_fft_ac_native_comparison.png")
    plt.savefig(save_path)
    
    print(f"\n--- Comparative Metrology Results (Native AC) ---")
