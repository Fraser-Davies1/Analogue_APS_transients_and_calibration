...
def run_final_transient():
    print("--- Starting Final Linearized Transients (Including 94% and Ref Waveform) ---")
    ...
    # Add the custom 94% point
    final_v_list.append((94, 2.4384)) 
    ...
    with Bench.open("bench.yaml") as bench:
        ...
        plt.title("Final Pixel Transients (2 Cycles)\nLinearized Intensity Sweep (10% to 94%) with Reset Reference")
        plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
        plt.grid(True, alpha=0.3)
        plt.tight_layout()
        plt.savefig("pixel_final_report_plot_94.png")
        print("\n--- Final Experiment Complete ---")
        print("Final plot saved to pixel_final_report_plot_94.png")
